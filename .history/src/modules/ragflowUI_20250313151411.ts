 ...
 */
  private static createRagFlowMenu() {
    ...
    // 聊天助手设置菜单项
    const chatAssistantSettingsMenu = document.createElement("menuitem");
    chatAssistantSettingsMenu.setAttribute("label", "聊天助手设置");
    chatAssistantSettingsMenu.addEventListener("command", () => {
      addon.openChatAssistantSettings();
    });
    ragflowMenu.appendChild(chatAssistantSettingsMenu);
